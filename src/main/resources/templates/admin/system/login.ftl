  ...
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href=""> <img alt="NucleicAcidTestManagement logo-sidebar" src="/admin/images/logo-sidebar.png"></a>
      </div>
      ...
      <footer class="col-sm-12 text-center">
        <p class="m-b-0">Copyright © 2022 <a href="${siteUrl!""}">【wenLiu】</a><a href="/admin/index/index">【search】</a>. All right reserved</p>
      </footer>
    </div>
  </div>
</div>
